...
%% doconce format latex PINNs.do.txt --print_latex_style=trac --latex_admon=paragraph
%%
...
Tentative deadline March 20. We would also like to propose that people who have formed groups present eventual projects on January 30. 
