...
% !split
\subsection{Overview of first week, January 19-23, 2026}
...
\noindent
% !split
\subsection{Both discriminative and generative}
...
% !split
\subsection{AI agents for Science}
...
% !split
\subsection{Project paths, overarching view}
...
% !split
\subsection{Classification projects}
...
% !split
\subsection{High-performance computing path}
...
% !split
\subsection{Write your own CNN or RNN (or even a light LLM) from scratch}
...
% !split
\subsection{Projects which link with the second part of the lectures}
...
% !split
\subsection{Reinforcement learning, PDE part}
...
% !split
\subsection{Gaussian processes and Bayesian analysis}
...
% !split
\subsection{More on projects and final grade}
...
% !split
\subsection{Test yourself: Deep learning 1}
...
\noindent
% !split
\subsection{Test yourself: Deep learning 2}
...
\noindent
% !split
\subsection{Test yourself: Optimization part}
...
\noindent
% !split
\subsection{Test yourself: Analysis of results}
\begin{enumerate}
...
% !split
\subsection{Reminder on  the basic Machine Learning ingredients}
\begin{block}{}
...
% !split
\subsection{Discipline  based statistical learning and data analysis}
...
\noindent
% !split
\subsection{The optimzation problem}
...
% !split
\subsection{Inputs to tje activation function}
