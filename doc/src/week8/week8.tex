...
\begin{frame}[plain,fragile]
\frametitle{Plans for the week March 9-13}
...
\begin{frame}[plain,fragile]
\frametitle{What is representation learning?}
...
\begin{frame}[plain,fragile]
\frametitle{Dimensionality reduction as approximation}
...
\begin{frame}[plain,fragile]
\frametitle{Undercomplete, overcomplete, and bottlenecks}
...
\begin{frame}[plain,fragile]
\frametitle{Empirical risk for autoencoders}
...
\begin{frame}[plain,fragile]
\frametitle{The Frobenius norm viewpoint}
...
\begin{frame}[plain,fragile]
\frametitle{Latent variables as coordinates}
...
\begin{frame}[plain,fragile]
\frametitle{A local linearization viewpoint}
...
\begin{frame}[plain,fragile]
\frametitle{Connection to classical methods}
...
\begin{frame}[plain,fragile]
\frametitle{When does reconstruction imply representation?}
...
\begin{frame}[plain,fragile]
\frametitle{A general regularized objective}
...
\begin{frame}[plain,fragile]
\frametitle{Why linear autoencoders matter}
...
\begin{frame}[plain,fragile]
\frametitle{Optimization problem in abstract form}
...
\begin{frame}[plain,fragile]
\frametitle{Autoencoders as identity approximation with constraints}
...
\begin{frame}[plain,fragile]
\frametitle{Reconstruction error decomposition}
...
\begin{frame}[plain,fragile]
\frametitle{Linear autoencoder architecture}
...
\begin{frame}[plain,fragile]
\frametitle{Matrix formulation of the training problem}
...
\begin{frame}[plain,fragile]
\frametitle{PCA as variance maximization}
...
\begin{frame}[plain,fragile]
\frametitle{PCA as projection minimization}
...
\begin{frame}[plain,fragile]
\frametitle{Expanding the linear AE loss}
...
\begin{frame}[plain,fragile]
\frametitle{Reduction to orthogonal projection}
...
\begin{frame}[plain,fragile]
\frametitle{Projector parameterization}
...
\begin{frame}[plain,fragile]
\frametitle{Geometric meaning of the theorem}
