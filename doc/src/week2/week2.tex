...
\begin{frame}[plain,fragile]
\frametitle{Overview of second  week, January 26-30, 2026}
...
\begin{frame}[plain,fragile]
\frametitle{Why Feed Forward Neural Networks (FFNN)? Classical approximation theorem}
...
\begin{frame}[plain,fragile]
\frametitle{Digression,  more updated variant}
...
\begin{frame}[plain,fragile]
\frametitle{Approximation used in practice}
...
\begin{frame}[plain,fragile]
\frametitle{Activation Functions Related to GELU}
...
\begin{frame}[plain,fragile]
\frametitle{Related Smooth or Gated Activations}
...
\begin{frame}[plain,fragile]
\frametitle{Transformer-Oriented Gated Variants}
...
\begin{frame}[plain,fragile]
\frametitle{Why GELU-like Activations?}
...
\noindent\textbf{Learning rate methods.}
...
\noindent\textbf{Usage of the above learning rate schedulers.}
...
\noindent\textbf{The Neural Network.}
...
\begin{frame}[plain,fragile]
\frametitle{Using Pytorch with the full MNIST data set}
